        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                <a class="nav-link  dropdown-toggle" href="#" id="languageDropdown" role="button"
                    ...
                    <i class="flag-icon flag-icon-ma mt-1" title="ma"></i> <span
                        class="ms-1 me-1 d-none d-md-inline-block">العربية</span>
                </a>
            ...
            <li class="nav-item dropdown">
                <a href="javascript:();" class="nav-link">
                    <i data-feather="moon" title="الوضع المضلم"
                            id="dark_mode"></i>
                </a>
            </li>
            <li class="nav-item dropdown">
                        ...
                        <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                            <div class="me-3">
                                <img class="wd-30 ht-30 rounded-circle"
                                    src="https://cdn-icons-png.flaticon.com/512/718/718064.png" alt="userr">
                            </div>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link  dropdown-toggle" href="#" id="profileDropdown" role="button"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle" src="https://cdn-icons-png.flaticon.com/512/718/718064.png"
                        alt="profile">
                </a>
